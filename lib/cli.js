    ...
    while (true) {
        ...
        if (selectedFormat === 'split') {
            ...
            if (centerMode !== 'none') {
                ...
                console.log(chalk_1.default.cyan.bold('🔪 (高级项) 是否需要向内收缩切片边缘，以摧毁遗留网格线/邻居越界重叠图案？\n'));
                ...
                const shaveChoices = [
                    ...
                    },
                    {
                        ...
                        description: '【强烈建议】当原画图案拥挤或越界，切出来的图总是带上邻居的手脚时，请使用此项加大收缩。',
                        value: -1,
                        titleColor: chalk_1.default.red.bold
                    }
                ];
                ...
                if (shaveChoice === -1) {
                    ...
                    while (!validPad) {
                        const padInput = await askQuestion(chalk_1.default.cyan.bold('\n🔪 请输入要切除的边缘向内收缩范围: ') +
                            chalk_1.default.gray('(建议输入 5~20 之间的正整数) '));
            ...
            console.log(chalk_1.default.cyan.bold('🩺 (附加项) 是否需要额外生成一张【全图切割蓝贴标尺参考图】？\n'));
