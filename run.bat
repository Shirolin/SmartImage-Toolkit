...
color 0f
echo =====================================================================================
echo    SmartImage-Toolkit - batch conversion
echo =====================================================================================
echo.
...
rem Double-clicked with no arguments: nothing to convert. Say so and wait for a key instead of
rem printing a success line and closing the window before the user can read anything.
if "%~1"=="" (
    echo.
    echo Nothing to convert: drop an image, or a folder of images, onto this .bat file.
    echo For the interactive menu use run_interactive.bat instead.
    echo.
    pause
    exit /b
)
